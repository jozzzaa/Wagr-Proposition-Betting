...
## need to create a ref- the person who can judge a question
	...
	p1 = Proposition.create(user_id: u1.id, title: "Will Et Go Home", description: "I want to know whats going to happen", image: "http://thepeoplesmovies.com/wp-content/uploads/2012/05/etbikescene-300x160.jpg", deadline: '23/08/2016/20/30/00', outcome: 'nil', category: "" )
