...
## need to create a ref- the person who can judge a question
	...
	p3 = Proposition.create(user_id: u3.id, title: "The queen of dragons will have her brother killed next episode", description: "In the last episode of Game of Thrones, Daenerys Targaryen's brother threathen her life. Do you think she will rise up and kill him or do you think she will let it go?", image: "http://digitalspyuk.cdnds.net/16/25/980x490/landscape-1466508335-20160602-ep609-publicity-still-00400095499.jpg", deadline: '07/08/2016/15/20/00', outcome: 'nil', category: "tv_shows")
	...
	p9 = Proposition.create(user_id: u2.id, title: "Can Patrick build a house", description: "Can Patrick build a house", image: "https://41.media.tumblr.com/a52527ae97937197d97c394fc91874a3/tumblr_inline_nvq2fkQ37q1s0fbfv_540.jpg", deadline: '02/10/2016/9/00/00', outcome: 'nil', category: "tv_shows" )
