...
## need to create a ref- the person who can judge a question
	...
	p4 = Proposition.create(user_id: u4.id, title: "It will be sunny in Adelaide tomorrow with <5% precipitation", description: "Adelaide is normally very sunny, tomrrow however the weather forecast predicts rainy weather. But this is wager and I want to bet against the odds, I think it will stay sunny.", image: "http://www.abc.net.au/news/image/658928-3x2-940x627.jpg", deadline: '02/05/2016/15:20:00', outcome: 'nil', category: "other" )

	p5 = Proposition.create(user_id: u5.id, title: "He will get high again next episode", description: "With the F Society now relying on him, with the impending destruction of the data centre, will he get high again to make it through or will he receover.", image: "https://pmctvline2.files.wordpress.com/2016/06/mr-robot-season-2-after-show.jpg?w=620&h=420&crop=1", deadline: '05/8/2016/17:20:00', outcome: 'nil', category: "tv_shows" )

	p6 = Proposition.create(user_id: u2.id, title: "Mike Ross will escape prison illegally", description: "Oh no Mr. Ross is in prison, but he can't be in their forever can he. Do you think he will be able to get out and will it be legal or illegal?", image: "http://cdn2.thr.com/sites/default/files/imagecache/scale_crop_768_433/2016/07/suits_s01e01_still_2.jpg", deadline: '26/8/2016/16:00:00', outcome: 'nil', category: "tv_shows" )

	p7 = Proposition.create(user_id: u6.id, title: "Magda's extreme ironing challenge", description: "Can Magda iron her clothes before deploying the parachute?", image: "http://slappedham.com/wp-content/uploads/2014/07/extreme-ironing-sky-dive.jpg", deadline: '27/8/2016/02:00:00', outcome: 'nil', category: "sport" )

	p8 = Proposition.create(user_id: u1.id, title: "Donald Trump runs for the toupee", description: "Can Donald Trump outrun his speedy toupee", image: "http://www.satiratribune.com/wp-content/uploads/2015/11/djt-hair.jpg", deadline: '27/8/2016/4:30:00', outcome: 'nil', category: "politics" )

	p9 = Proposition.create(user_id: u2.id, title: "Can Patrick build a house", description: "Can Patrick build a house", image: "https://41.media.tumblr.com/a52527ae97937197d97c394fc91874a3/tumblr_inline_nvq2fkQ37q1s0fbfv_540.jpg", deadline: '27/8/2016/11:11:00', outcome: 'nil', category: "tv_shows" )

	p10 = Proposition.create(user_id: u2.id, title: "Will Matt Damon take his wife to mars", description: "Matt Damon wants to go to mars more than anything in the world! Can he persude his wife", image: "http://cdn.movieweb.com/img.news.tops/NEFs7NFMwKZnJL_1_b.jpg", deadline: '20/8/2016/10:11:00', outcome: 'nil', category: "celebrity" )

	p11 = Proposition.create(user_id: u2.id, title: "Can Dt get the highest score in Goat Simulator", description: "All the years of practice has lead to the championships", image: "https://i.kinja-img.com/gawker-media/image/upload/s--GfPQNgM---/x5kiy44eakeyephru0g8.jpg", deadline: '28/7/2016/11:11:00', outcome: 'nil', category: "games" )

	p12 = Proposition.create(user_id: u8.id, title: "Can the Norwegian curling team take the gold", description: "The most important sports event of histroy", image: "http://media1.s-nbcnews.com/j/MSNBC/Components/Slideshows/_production/ss-100223-Olympic-fashions/TODAY-Olympic-Costumes-norway-curling-tease.today-ss-slide-desktop.jpg", deadline: '26/8/2016/17:00:00', outcome: 'nil', category: "games" )

	p13 = Proposition.create(user_id: u8.id, title: "Will Scotlands celebrity bessie take the gold for the 4th year", description: "Bessie is basically scotlands usain bolt when it comes to being a cow", image: "https://thecrtblog.files.wordpress.com/2013/07/cassandra.jpg", deadline: '27/8/2016/01:00:00', outcome: 'nil', category: "games" )
